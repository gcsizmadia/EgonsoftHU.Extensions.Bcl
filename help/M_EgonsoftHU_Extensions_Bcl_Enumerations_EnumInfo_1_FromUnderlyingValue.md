# FromUnderlyingValue(Byte) Method
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.byte" target="_blank" rel="noopener noreferrer">Byte</a></dt><dd>The underlying value of an enumeration value.</dd></dl>
