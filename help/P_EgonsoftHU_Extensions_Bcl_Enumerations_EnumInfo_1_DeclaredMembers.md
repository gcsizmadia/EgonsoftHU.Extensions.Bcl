...
**C#**
``` C#
public static IReadOnlyCollection<EnumInfo<TEnum>> DeclaredMembers { get; }
```
**VB**
``` VB
Public Shared ReadOnly Property DeclaredMembers As IReadOnlyCollection(Of EnumInfo(Of TEnum))
	Get
```
