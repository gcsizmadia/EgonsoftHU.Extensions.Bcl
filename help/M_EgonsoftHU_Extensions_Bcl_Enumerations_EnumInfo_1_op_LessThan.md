...
Indicates whether the *left* parameter is less than the *right* parameter.
...
true if the left-hand operand is less than the right-hand operand; otherwise, false.
