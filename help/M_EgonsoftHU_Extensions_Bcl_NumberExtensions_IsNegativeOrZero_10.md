# IsNegativeOrZero(UInt64) Method
...
This function returning false does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsPositive_10.md">IsPositive(UInt64)</a> will return true.
