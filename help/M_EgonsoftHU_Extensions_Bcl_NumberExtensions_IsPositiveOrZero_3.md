# NumberExtensions.IsPositiveOrZero Method (Half)
...
This function returning `false` (`False` in Visual Basic) does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsNegative_3.md">IsNegative(Half)</a> will return `true` (`True` in Visual Basic).
