# IsNegativeOrZero(Single) Method
...
This function returning false does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsPositive_7.md">IsPositive(Single)</a> will return true.
