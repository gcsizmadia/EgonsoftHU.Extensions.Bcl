# FromUnderlyingValue(UInt32) Method
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.uint32" target="_blank" rel="noopener noreferrer">UInt32</a></dt><dd>The underlying value of an enumeration value.</dd></dl>
