...
**C#**
``` C#
public static EnumInfo<TEnum> FromValue<TEnum>(
	TEnum value
)
...
**VB**
``` VB
Public Shared Function FromValue(Of TEnum As {Structure, New}) ( 
	value As TEnum
...
#### Parameters
<dl><dt>  TEnum</dt><dd>An enumeration value.</dd></dl>
