...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a><br />A string value returned by the *valueSelector* if it is not equal to a null reference (`Nothing` in Visual Basic); otherwise, a null reference (`Nothing` in Visual Basic).
