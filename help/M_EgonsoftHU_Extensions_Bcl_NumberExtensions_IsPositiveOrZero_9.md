# IsPositiveOrZero(UInt32) Method
...
This function returning false does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsNegative_9.md">IsNegative(UInt32)</a> will return true.
