# NumberExtensions.IsNegativeOrZero Method (Int32)
...
This function returning `false` (`False` in Visual Basic) does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsPositive_5.md">IsPositive(Int32)</a> will return `true` (`True` in Visual Basic).
