# NumberExtensions.IsPositiveOrZero Method (Decimal)
...
This function returning `false` (`False` in Visual Basic) does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsNegative_1.md">IsNegative(Decimal)</a> will return `true` (`True` in Visual Basic).
