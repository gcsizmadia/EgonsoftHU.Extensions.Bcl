# NumberExtensions.IsNegativeOrZero Method (UInt16)
...
This function returning `false` (`False` in Visual Basic) does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsPositive_9.md">IsPositive(UInt16)</a> will return `true` (`True` in Visual Basic).
