# IsNegativeOrZero(UInt16) Method
...
This function returning false does not imply that <a href="M_EgonsoftHU_Extensions_Bcl_NumberExtensions_IsPositive_8.md">IsPositive(UInt16)</a> will return true.
