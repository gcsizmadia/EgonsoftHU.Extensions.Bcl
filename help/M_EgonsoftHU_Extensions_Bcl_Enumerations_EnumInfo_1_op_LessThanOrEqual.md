...
Indicates whether the *left* parameter is less than or equal to the *right* parameter.
...
true if the left-hand operand is less than or equal to the right-hand operand; otherwise, false.
