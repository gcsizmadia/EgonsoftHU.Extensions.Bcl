...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a></dt><dd>The value that needs to end with a slash '<code>/</code>' character.</dd></dl>

#### Return Value
<a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a>  
*value* itself if it ends with a slash '`/`' character; otherwise, appends a slash '`/`' character at the end of it.
