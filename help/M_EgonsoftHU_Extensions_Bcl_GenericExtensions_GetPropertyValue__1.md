# GetPropertyValue&lt;TSource&gt; Method
...
#### Parameters
<dl><dt>  TSource</dt><dd>The source object whose property value should be get.</dd><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a></dt><dd>The name of the property whose value should be get.</dd></dl>
...
A property value of the source object if the property exists; otherwise, null.
